...
var _finishStartedShifts = function () {
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.next = 2;
                        return shiftService.finishStartedShifts();
    ...
    return function _finishStartedShifts() {
...
function _setapApiEndpoints() {
    ...
    app.get('/salesman/getCurrentShiftForRandomTests', function () {
            ...
            return _regenerator2.default.wrap(function _callee19$(_context19) {
                while (1) {
                    switch (_context19.prev = _context19.next) {
                        ...
                        case 3:
                            _context19.next = 5;
                            return shiftService.reportExpenses(req.body.sessionId, req.body.shiftId, req.body.km, req.body.parking, req.body.extraExpenses);
    ...
    app.post('/salesman/submitConstraints', function () {
                ...
                while (1) {
                    switch (_context21.prev = _context21.next) {
                        ...
                        case 3:
                            ...
                            _context21.prev = 4;
                            _context21.next = 7;
                            return shiftService.submitConstraints(req.body.sessionId, req.body.constraints);
