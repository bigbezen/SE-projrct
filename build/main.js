            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        ...
                        case 3:
                            _context8.next = 5;
                            return shiftService.reportSale(req.body.sessionID, req.body.shiftId, req.body.productId, req.body.quantity);
            ...
            return _regenerator2.default.wrap(function _callee9$(_context9) {
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        ...
                        case 3:
                            _context9.next = 5;
                            return shiftService.reportOpened(req.body.sessionID, req.body.shiftId, req.body.productId, req.body.quantity);
